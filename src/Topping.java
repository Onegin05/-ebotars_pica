...
public class Topping extends JFrame {
		...
		public Topping() {
			...
			JLabel becons = new JLabel(new ImageIcon(""));
			panel.add(becons);
			becons.setBounds(50,70,300,300);
			
			JLabel peperoni = new JLabel(new ImageIcon(""));
			panel.add(peperoni);
			peperoni.setBounds(350,70,300,300);
			
			JLabel siers = new JLabel(new ImageIcon(""));
			panel.add(siers);
			siers.setBounds(50,400,300,300);
			
			JLabel sipols = new JLabel(new ImageIcon(""));
			panel.add(sipols);
